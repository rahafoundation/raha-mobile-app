...
#
# Fix for issue with "Argument list too long: recursive header expansion failed at..."
# From: https://github.com/react-native-community/react-native-camera/issues/1407
